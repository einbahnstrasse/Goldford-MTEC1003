...
_Refer to the [Tutorial on Pull Requests + Merge Conflicts](/Goldford-MTEC1003-OL78/labs/04/git.pull.requests.and.merge.tutorial.v01.html){:target="_blank"} and to [Lab 3](https://einbahnstrasse.github.io/Goldford-MTEC1003-OL78/labs/03/lab-03-git-intro.html){:target="_blank"} for an explanation of the steps below._
