...
<img src="/Goldford-MTEC1003/labs/04/img.token/01.png" width="200px">  

On the next page, there is a left sidebar. Scroll down and click on the **Developer Settings** button:  

<img src="/Goldford-MTEC1003/labs/04/img.token/02.png" width="454px">  
...
<img src="/Goldford-MTEC1003/labs/04/img.token/03.png" width="2000px">
...
<img src="/Goldford-MTEC1003/labs/04/img.token/04.png" width="2000px">

Now, scroll down to the bottom of this page and click the green **Generate token** button:  

<img src="/Goldford-MTEC1003/labs/04/img.token/05.png" width="436px">
...
<img src="/Goldford-MTEC1003/labs/04/img.token/06.png" width="2000px">
...
In Terminal, resuming just where we'd paused our work in either [Lab 3](/Goldford-MTEC1003/labs/03/lab-03-git-intro.html){:target="_blank"} or [Lab 4 / Part 2](/Goldford-MTEC1003/labs/04/lab-04-git-part-02a.html){:target="_blank"}, type the following long command:  
...
<img src="/Goldford-MTEC1003/labs/04/img.token/07.png" width="2000px">
...
Once you've completed the steps in this tutorial, return to the tutorial you are actively working on: either [Lab 3](/Goldford-MTEC1003/labs/03/lab-03-git-intro.html){:target="_blank"} or [Lab 4 / Part 2](/Goldford-MTEC1003/labs/04/lab-04-git-part-02a.html){:target="_blank"} exactly where the link to this tutorial appears, and resume work on your lab.    
