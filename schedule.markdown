...
<a id="w1"></a>
<h3 class="schedule-page-date">Week 1: {{ site.week-01 }}</h3>
...
### [Week 2 Quizlet](https://forms.gle/HATbmpjGLvWqAJ1f9){:target="_blank"}  
...
### [Week 3 Quizlet](https://forms.gle/WMoHW6EW3TB2VVeHA){:target="_blank"}  
* _Complete the quizlet above as part of today's attendance + participation._   
